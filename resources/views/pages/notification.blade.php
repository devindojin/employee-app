	      	...
	      	<div class="panel_form">
		        <div class="form-group">
		          ...
		          <select class="form-control input-lg classic" name="poste_title">
		            <option value="1" @if(old("poste_title") == "1") selected="selected" @else @endif>1</option>
		            <option value="2" @if(old("poste_title") == "2") selected="selected" @else @endif>2</option>
		            <option value="3" @if(old("poste_title") == "3") selected="selected" @else @endif>3</option>
		            <option value="4" @if(old("poste_title") == "4") selected="selected" @else @endif>4</option>
		          </select>
		        </div>
	      	</div>
	    </div>
