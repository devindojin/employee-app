	...
	<div class="job-section">
		...
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<div class="panel_form">
				<p class="default_text">Déposez votre cv afin de pouvoir commencer à postuler aux offres et être vu(e) par les recruteurs</p>
				<div class="form-group text-center">
					<label for="">DÉPOSER UN CV AVEC:</label>
					<div class="dropzone">
						<div id="dropzone">
